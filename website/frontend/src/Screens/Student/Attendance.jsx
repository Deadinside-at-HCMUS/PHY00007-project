...
const StudentAttendance = () => {
    ...
    const getAllAttendanceHandler = () => {
        ...
        axios
            .get(
                `${baseApiURL()}/attendance/getAttendance/student/${
            ...
            .then((response) => {
                if (response.data.success) {
                    ...
                    const uniqueSubjects = [
                        ...new Set(
                            response.data.attendance.map((item) => item.subject)
                        ),
                    ];
            ...
            <div className="mt-8 w-full">
                <div className="flex items-center mb-8 ml-2">
                    ...
                    <select
                        ...
                        value={filterSubject || ""}
                        onChange={(e) =>
                            setFilterSubject(e.target.value || null)
                        }
                    >
                    ...
                    <div className="ml-5 mr-2">
                        ...
                        <select
                            ...
                            value={filterWeek || ""}
                            onChange={(e) =>
                                setFilterWeek(e.target.value || null)
                            }
                        >
                        ...
                        {filteredAndSortedAttendance().map((item) => (
                            ...
                            >
                                <div>
                                    ...
                                    <p>
                                        <strong>Date:</strong>{" "}
                                        {formatDate(item.time)} &emsp;
                                        <strong>Time:</strong>{" "}
                                        {formatTime(item.time)} &emsp;
